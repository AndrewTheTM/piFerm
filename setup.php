...
$sqlCreateSitRep = "CREATE TABLE fermpi.sitrep(sitrepId INT PRIMARY KEY AUTOINCREMENT, beverageName CHAR(50), statusText CHAR(20));";
...
$db->exec($sqlCreateSitRep) or die("There was an error");
